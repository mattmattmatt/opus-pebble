...
function setUiFromState(config) {
    ...
    _.each(config.hosts, function(host, index) {
        $('#host-container').append('<fieldset class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><input class="mdl-textfield__input js-host-address" type="text" '+ (index === 0 ? 'required="required" ' : ' ') + ' autocapitalize="off" autocorrect="off" id="addr-'+index+'" value="'+host.address+'"><label class="mdl-textfield__label" for="addr-'+index+'">Kodi IP Address and Port</label></fieldset><fieldset class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><input class="mdl-textfield__input js-host-name" type="text" id="name-'+index+'" value="'+host.name+'"><label class="mdl-textfield__label" for="name-'+index+'">Host Name</label></fieldset><fieldset class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><input class="mdl-textfield__input js-host-username" type="text" id="username-'+index+'" value="'+host.username+'"><label class="mdl-textfield__label" for="username-'+index+'">Username (optional)</label></fieldset><fieldset class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><input class="mdl-textfield__input js-host-password" type="text" id="password-'+index+'" value="'+host.password+'"><label class="mdl-textfield__label" for="password-'+index+'">Password (optional)</label></fieldset>');
    });
